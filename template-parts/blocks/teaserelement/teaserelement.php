...
<div class="row space-between">
    <div class="col-md-6 col-sm-12 col-has">
        <div class="teaserelement-box flex-box-column has-box-padding has-box-bg" style="background-image: url('<?php echo $teaserbackgroundimageleft; ?>');">
            <h2><?php echo $teaserueberschriftleft; ?></h2>
            <div class="bottom-link-wrap">
                <a href="<?php echo $teaserlinkleft; ?>"><?php echo $teasersubheadlineleft; ?></a>
            </div>
        </div>
    </div>

    <div class="col-md-6 col-sm-12 col-has">
        <div class="teaserelement-box flex-box-column has-box-padding has-box-bg" style="background-image: url('<?php echo $teaserbackgroundimageright; ?>');">
            <h2><?php echo $teaserueberschriftright; ?></h2>
            <div class="bottom-link-wrap">
                <a href="<?php echo $teaserlinkright; ?>"><?php echo $teasersubheadlineright; ?></a>
            </div>
        </div>
    </div>
</div>