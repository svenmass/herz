...
(function (app, win) {
  ...
  document.getElementsByClassName ||
    (document.getElementsByClassName = function (e) {
      ...
      if (t.evaluate) {
        (r = ".//*[contains(concat(' ', @class, ' '), ' " + e + " ')]"),
          (n = t.evaluate(r, t, null, 0, null));
  ...
  function contentLoaded(n, t) {
    var l = 'complete',
      ...
      r = function (e) {
        (e.type != s || i.readyState == l) &&
          ((e.type == 'load' ? n : i)[v](f + e.type, r, u),
          !h && (h = !0) && t.call(n, null));
      },
      o = function () {
        try {
  ...
  function selector(a) {
    ...
    var ret = [];
    b !== null &&
      (b.length ? (ret = b) : b.length === 0 ? (ret = b) : (ret = [b]));
    return ret;
  }
  ...
  app.run = function (o) {
    ...
    for (var l = bgnodes.length, i = 0; i < l; i++) {
      var src = window
        .getComputedStyle(bgnodes[i], null)
      ...
      if (flags) {
        ...
        var holder = parse_flags(
          bgsrc
            .substr(
              bgsrc.lastIndexOf(options.domain) + options.domain.length + 1
            )
            .split('/'),
          options
        );
    ...
    for (l = images.length, i = 0; i < l; i++) {
      ...
      if (
        attr_datasrc == null &&
        !!attr_src &&
        attr_src.indexOf(options.domain) >= 0
      ) {
        src = attr_src;
      ...
      if (src) {
        var holder = parse_flags(
          src
            .substr(src.lastIndexOf(options.domain) + options.domain.length + 1)
            .split('/'),
          options
        );
        if (holder) {
